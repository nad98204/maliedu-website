...
import { HERO_TITLE_SRCSET, HERO_TITLE_SIZES, HERO_POSTER, HERO_POSTER_SRCSET, HERO_POSTER_SIZES } from "./heroAssets";
...
const KhoiThongDongTien = ({ targetFunnel, source_key, seoPath = "/dao-tao/khoi-thong-dong-tien", heroContent, painContent, audienceContent, scheduleContent, founderContent, registration }) => {
  ...
  return (
    ...
    >
      <SEO {...seo} preloadLcpImage={heroContent?.compact ? HERO_POSTER : KHOI_THONG_HERO_BANNER_URL} preloadLcpImageSrcSet={heroContent?.compact ? HERO_POSTER_SRCSET : HERO_TITLE_SRCSET} preloadLcpImageSizes={heroContent?.compact ? HERO_POSTER_SIZES : HERO_TITLE_SIZES} />
